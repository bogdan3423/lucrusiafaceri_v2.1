        ...
        <div className="px-3 py-3 md:px-4 flex items-center justify-between border-t border-gray-100">
          <div className="flex items-center gap-4">
            ...
            <div className="relative">
              ...
              {/* Share Menu - Bottom Sheet on Mobile, Centered Modal on Desktop */}
              {showShareMenu && (
                <>
                  ...
                  {/* Share Panel - Bottom sheet on mobile, centered modal on desktop */}
                  <div className="fixed inset-x-0 bottom-0 bg-white rounded-t-2xl p-4 pb-8 z-50 md:inset-auto md:top-1/2 md:left-1/2 md:-translate-x-1/2 md:-translate-y-1/2 md:rounded-2xl md:p-6 md:w-[320px] md:shadow-2xl">
                    {/* Header */}
                    ...
                    <div className="grid grid-cols-4 gap-3">
                      ...
                      >
                        <div className="w-14 h-14 rounded-full bg-green-500 flex items-center justify-center shadow-sm">
                      ...
                      <button
                        ...
                        className="flex flex-col items-center gap-2 p-2 rounded-xl hover:bg-gray-50 transition-colors"
                      >
                        <div className="w-14 h-14 rounded-full bg-gradient-to-br from-purple-600 via-pink-500 to-orange-400 flex items-center justify-center shadow-sm">
                          <svg className="w-7 h-7 text-white" fill="currentColor" viewBox="0 0 24 24">
                      ...
                      <button
                        ...
                        className="flex flex-col items-center gap-2 p-2 rounded-xl hover:bg-gray-50 transition-colors"
                      >
                        <div className="w-14 h-14 rounded-full bg-gray-200 flex items-center justify-center shadow-sm">
                          <svg className="w-6 h-6 text-gray-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 16H6a2 2 0 01-2-2V6a2 2 0 012-2h8a2 2 0 012 2v2m-6 12h8a2 2 0 002-2v-8a2 2 0 00-2-2h-8a2 2 0 00-2 2v8a2 2 0 002 2z" />
                          </svg>
                        </div>
                        <span className="text-xs font-medium text-gray-700">Copiază</span>
                      </button>
                    </div>
                  </div>
                </>
